...
namespace CSharpClass.Lessons
{
    public class Lesson7
    {
        public void BasicMath()
        {
         ...
         /*
         The shit left operator will take the value as an primitive type and 
        ...
        {
            // The number 15 converted to binary = 111
            int value = 15;
        ...
        /*
         ...
         When x is of uint or ulong, the low-order bits of x are discarded,
         the remaining bits are shifted right, and the high-order empty bit 
        ...
        the set's 1's carry over to answers */
        public void MyOrAssignmentOperator()
        {
            ...
            Console.WriteLine(value);
        } // end method or my assignment operator
